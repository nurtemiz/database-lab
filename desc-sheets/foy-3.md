...
## Saklı Yordamlar (Stored Procedures), Fonksiyonlar (Functions), İmleçler (Cursorler ), Transaction Blokları
...
Resim-2 Ogrenci tablosuna verilerin girilmesi
...
Resim-3 add_student prosedürünün oluşturulması
...
Resim-4 add_student prosedürünün kullanılması
...
Resim-11 delete_trigger trigger-in oluşturulması
...
Resim-12 delete_trigger trigger-in kullanılması
